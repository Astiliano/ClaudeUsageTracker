...
- Dashboard: `gate: "active"`, `busy: false`, `halted: null`, `stalled_at: null`, `binary: { path: "C:\\Users\\isjav\\.local\\bin\\claude.exe", source: "local_bin" }`, `interval_secs: 60`.
